...
1. 判断这到底算不算已经吃了。
2. 估热量、蛋白、缺口，也顺手估当天膳食纤维、钠、钙、维生素等关键营养维度，写入本地 JSON。
...
- 今日营养维度：只展示当天的膳食纤维、钠、钙、钾、铁、维生素C/D/B12和下一餐建议
- 支持按早餐 / 午餐 / 晚餐 / 加餐筛选
...
Agent 能从包装、品牌公开数据或餐食照片里推出来就写；推不出来也不影响热量和蛋白记录。
...
- 能推出来时，顺手估今日膳食纤维、钠、钙、钾、铁、维生素C、维生素D、维生素B12。
- 营养维度只展示今日状态和下一餐建议，不把长期日历变成复杂的微量营养报表。
- 普通记录短回复，用户问建议时再展开分析。
...
- 想顺手知道今天是不是缺菜、钠是不是高、钙和维生素有没有明显短板的人
